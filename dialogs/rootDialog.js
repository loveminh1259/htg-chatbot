...
class RootDialog extends ComponentDialog {
    ...
    constructor(userState) {
        ...
        const timeSlots = [
            new SlotDetails('hour', 'number', 'Please enter hour you want to notify'),
            new SlotDetails('minute', 'number', 'Please enter minute you want to notify')
        ];
        ...
        const slots = [
            new SlotDetails('hour', 'number', 'Please enter hour.'),
            new SlotDetails('minute', 'number', 'Please enter minute.')
        ...
        this.addDialog(new SlotFillingDialog('fullname', timeSlots));
